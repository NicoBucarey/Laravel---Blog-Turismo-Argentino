...
@section('content')
    ...
    <p class="text-sm text-gray-600">Publicado: {{ $post->created_at ? $post->created_at->format('d/m/Y') : 'N/A' }}</p>
    <p class="mt-2 text-gray-700">{{ $post->excerpt ?? Str::limit($post->content, 150) }}</p>
</a>
